...
return [
    ...
    'settings' => [
        ...
        'ip_adapter' => 'IP correlation adapter',
        'ip_adapter_ipv6_adapter' => 'ipv6-adapter.com (default)',
        'ip_adapter_ipify' => 'ipify.org',
        'ip_adapter_info' => 'Pick ipify if ipv6-adapter.com is no longer working for your players.',
